...
/**
 * An activity representing a single Servicio de Taxi detail screen. This
 ...
 * {@link ServiciodeTaxiListActivity}.
 * <p>
 * This activity is mostly just a 'shell' activity containing nothing more than
 * a {@link ServiciodeTaxiDetailFragment}.
 */
public class ServiciodeTaxiDetailActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			...
			arguments.putString(
					ServiciodeTaxiDetailFragment.ARG_ITEM_ID,
					getIntent().getStringExtra(
							ServiciodeTaxiDetailFragment.ARG_ITEM_ID));
			ServiciodeTaxiDetailFragment fragment = new ServiciodeTaxiDetailFragment();
			fragment.setArguments(arguments);
			getSupportFragmentManager().beginTransaction()
					.add(R.id.serviciodetaxi_detail_container, fragment)
					.commit();
		}
	}
